#!/usr/bin/env node
/**
 * Smoke test pentru ShapeSquad — prod deploy.
 *
 * Verifică:
 *   1. https://shapesquad.vercel.app răspunde HTTP 200
 *   2. HTML-ul conține titlul așteptat (confirmă deploy fresh, nu cached error page)
 *
 * Usage: `npm run smoke:prod`
 */

const PROD_URL = 'https://shapesquad.vercel.app';
const EXPECT = ['<title>ShapeSquad — body composition tracker</title>'];
